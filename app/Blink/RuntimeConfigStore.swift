...
enum RequestMode: String, CaseIterable, Codable, Identifiable {
    ...
    var title: String {
        ...
        case .sourcePacketTargetOCROrFullImage:
            return "Source Packet + OCR Fallback"
        case .sourceOCRTargetTextOrFullImage:
            return "Experimental: Source OCR + Text Target Fallback"
        }
    }
    ...
    var detail: String {
        ...
        case .sourcePacketTargetOCROrFullImage:
            return "Use OCR packet when it looks sufficient, otherwise fall back to full target image."
        case .sourceOCRTargetTextOrFullImage:
            return "Use native source OCR paragraphs, route to text-only target inference for strong text fields, and fall back to full target image otherwise."
        }
    }
...
struct RuntimeSelectionSnapshot {
    ...
    let targetTextOnlyPromptPath: URL?
    ...
    var payload: [String: Any] {
        [
            ...
            "paths": [
                ...
                "target_text_only_prompt": targetTextOnlyPromptPath?.path as Any,
            ],
        ]
    }
}
...
final class RuntimeConfigStore: ObservableObject {
    ...
    func currentSnapshot() -> RuntimeSelectionSnapshot {
        ...
        return RuntimeSelectionSnapshot(
            ...
            targetTextOnlyPromptPath: Paths.activePromptPath(named: "target_text_only_prompt.txt")
        )
    }
    ...
    var promptDescriptors: [PromptDescriptor] {
        [
            ...
            ("target_text_only_prompt", "Target Text-Only Prompt", "target_text_only_prompt.txt"),
