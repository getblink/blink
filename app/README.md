...
- request-mode toggles (`baseline`, `source packet + full target`, `source packet + target OCR packet`, `source packet + OCR fallback`, `experimental local source text/OCR + target context fallback`)
